...
<div>
    ...
    <div class="container" align="center">
        ...
        <table class="table table-success table-striped">
            ...
            <c:forEach var="customer" items="${customerList}">
                <tr>
                    ...
                    <td>
                        <c:if test="${customer.idType == 1}">
                            Diamond
                        </c:if>
                        <c:if test="${customer.idType == 2}">
                            Platinium
                        </c:if>
                        <c:if test="${customer.idType == 3}">
                            Gold
                        </c:if>
                        <c:if test="${customer.idType == 4}">
                            Silver
                        </c:if>
                        <c:if test="${customer.idType == 5}">
                            Member
                        </c:if>
                    </td>
                    ...
                    <td>
                        <a href="/customer?action=edit&id=${customer.id}"><button type="button"> Edit </button></a>
                        <button type="button"  onclick="infoDelete('${customer.id}','${customer.name}')"
        ...
        <a href="/customer?action=create"><button class="button">Add New Customer</button></a>
    </div>
